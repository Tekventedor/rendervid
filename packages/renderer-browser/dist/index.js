...
function getAnimationPropertiesAtFrame(animation, frame, fps, sceneDuration, layerSize) {
  ...
  if (!animKeyframes && effect) {
    animKeyframes = core.generatePresetKeyframes(effect, {
  ...
  return core.getPropertiesAtFrame(animKeyframes, localFrame);
}
function getAnimationStartProperties(animation, layerSize) {
  ...
  return core.getPropertiesAtFrame(animKeyframes, 0);
}
function getAnimationEndProperties(animation, layerSize) {
  ...
  return core.getPropertiesAtFrame(animKeyframes, duration);
}
...
function createGradientDef(gradient, id) {
  ...
  if (type === "radial") {
    return /* @__PURE__ */ jsxRuntime.jsx("radialGradient", { id, cx: "50%", cy: "50%", r: "50%", children: colors.map((stop, i) => /* @__PURE__ */ jsxRuntime.jsx("stop", { offset: `${stop.offset * 100}%`, stopColor: stop.color }, i)) });
  }
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("linearGradient", { id, x1: `${x1}%`, y1: `${y1}%`, x2: `${x2}%`, y2: `${y2}%`, children: colors.map((stop, i) => /* @__PURE__ */ jsxRuntime.jsx("stop", { offset: `${stop.offset * 100}%`, stopColor: stop.color }, i)) });
}
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsxs(
        "svg",
        {
          ...
          style: { display: "block" },
          children: [
            gradient && /* @__PURE__ */ jsxRuntime.jsx("defs", { children: createGradientDef(gradient, gradientId) }),
            renderShape()
          ]
        }
      )
...
function GroupLayer({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    "div",
    {
      ...
      className: layer.className,
      children: layer.children?.map((child) => /* @__PURE__ */ jsxRuntime.jsx(
        LayerRenderer,
        {
          layer: child,
          frame,
...
function LayerRenderer({
  ...
  switch (layer.type) {
    case "image":
      return /* @__PURE__ */ jsxRuntime.jsx(ImageLayer, { layer, ...commonProps });
    case "text":
      return /* @__PURE__ */ jsxRuntime.jsx(TextLayer, { layer, ...commonProps });
    case "video":
      return /* @__PURE__ */ jsxRuntime.jsx(VideoLayer, { layer, ...commonProps, isPlaying });
    case "shape":
      return /* @__PURE__ */ jsxRuntime.jsx(ShapeLayer, { layer, ...commonProps });
    case "audio":
      return /* @__PURE__ */ jsxRuntime.jsx(AudioLayer, { layer, ...commonProps, isPlaying });
    case "group":
      return /* @__PURE__ */ jsxRuntime.jsx(
        GroupLayer,
        {
...
function SceneRenderer({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    "div",
    {
      ...
      children: sortedLayers.map((layer) => /* @__PURE__ */ jsxRuntime.jsx(
        LayerRenderer,
        {
          layer,
          frame,
...
function createFrameCapturer() {
  async function captureFrame(options) {
    ...
    const canvas = await html2canvas__default.default(options.element, {
      width: options.width,
...
var BrowserRenderer = class {
  ...
  async renderVideo(options) {
    ...
    try {
      ...
      this.root = client.createRoot(renderContainer);
...
exports.canvasToVideoFrame = canvasToVideoFrame;
exports.createBrowserRenderer = createBrowserRenderer;
exports.createFrameByFrameRecorder = createFrameByFrameRecorder;
exports.createFrameCapturer = createFrameCapturer;
exports.createGifEncoder = createGifEncoder;
exports.createMediaRecorderEncoder = createMediaRecorderEncoder;
exports.createMp4Muxer = createMp4Muxer;
exports.createOffscreenCapturer = createOffscreenCapturer;
exports.createWebCodecsEncoder = createWebCodecsEncoder;
exports.createWebMMuxer = createWebMMuxer;
exports.downloadArrayBuffer = downloadArrayBuffer;
exports.downloadBlob = downloadBlob;
exports.getBestMimeType = getBestMimeType;
exports.getRecommendedCodec = getRecommendedCodec;
...
exports.useLayerAnimation = useLayerAnimation;
